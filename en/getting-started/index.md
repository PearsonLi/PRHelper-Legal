...
<section class="story-panel"><p class="story-kicker">A useful first session</p><h2>Do not start by rebuilding five years.</h2><p>Start with the trip you remember best. Enter the exit, the return and the source that confirms each date. Once one record is trustworthy, add up to four more.</p></section>
...
<ol>
  ...
  <li>Add up to four more trips, newest first.</li>
