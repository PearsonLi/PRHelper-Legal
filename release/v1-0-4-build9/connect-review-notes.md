---
title: Connect Review Notes - v1.0.4 build 9
permalink: /release/v1-0-4-build9/connect-review-notes/
---

# Review Notes (v1.0.4 build 9)

## EN
Release: v1.0.4 (build 9)
...
- Data-recovery behavior in this build:
  - Reinstall/cloud restore keeps member-domain data in recovery path (no destructive truncation on restore).
  - If Family is locked, app falls back to primary member view without deleting stored family data.
- Version-scoped legal URLs:
  - Terms EN: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-4-build9/
  - Privacy EN: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-4-build9/
...
- 本版本数据恢复行为：
  - 重装/云端恢复路径保留家庭成员域数据，不做破坏性清空。
  - 家庭版未解锁时会回退到主成员视图，但不会删除已存储的家庭成员数据。
- 本版本法务链接：
  - 服务条款（中文）：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-4-build9/
  - 隐私政策（中文）：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-4-build9/
