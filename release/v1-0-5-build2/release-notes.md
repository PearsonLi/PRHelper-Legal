---
title: Release Notes - v1.0.5 build 2
permalink: /release/v1-0-5-build2/release-notes/
---

# Release Notes - v1.0.5 (build 2)

- Generated at: 20260322_1646
- Previous version baseline: v1.0.5-build1
...
- Manage temporary-residence records in Travel and apply citizenship credit calculation.
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-5-build2/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-5-build2/
...
- 临时居留在旅行页统一管理，并用于入籍折算计算。
- 提供 5 年滚动趋势图与风险提醒。
- 提供旅行记录导入导出能力，便于备份与校核。

数据默认仅存储在本机。本应用为记录与规划工具，不构成法律意见。

服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-5-build2/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-5-build2/
...
- 2bec091 Refine travel/pre-PR UX and update free-limit wording
- 08f4169 Move temporary residence management from citizenship tab to travel accordion
- 70f4496 refactor(settings): move PR/Citizenship rules into FAQ page
- 89a06eb fix(bug): hide history trip signals and suppress same-day target labels
- 8e67b17 fix(bug): hide same-day eligibility marker on pr/citizenship charts
- 3fe92c9 fix(bug): gate target-date labels and prevent chart label overlap
- ac1aa17 fix(pr-citizenship): lock evaluation to today-plus-3-years
- 73dff2b feat(ux): show one-time migration notice for v3 schema upgrade
- 42ef46d fix(db): handle cross-day zero-absence trips in backup export/import
- e4e2756 feat(schema): add isDeparture/isEntry trip boundary flags (schema v3)
- a873326 fix(travel): write entry-day event and allow zero-absence-trip merge in timeline
- 5fac313 refactor(travel): rename SAME_DAY_TRIP to ZERO_ABSENCE_TRIP for correct semantics
- 8174cbc fix(travel): allow saving zero-absence-day trips (e.g. Saturday out, Sunday back)
- 0eae4c4 chore(release): gate release docs with public 200 check

## 4) QA Test Guide

### Required functional checks
1. Onboarding: consent gate and links.
2. Travel: add/update/delete with overlap validation and temporary-residence accordion management.
3. PR page: chart rendering, threshold crossing, risk reminders.
4. Citizenship page: calendar/trend modes, eligibility curve, and evaluation date behavior.
