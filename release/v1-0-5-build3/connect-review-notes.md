---
title: Connect Review Notes - v1.0.5 build 3
permalink: /release/v1-0-5-build3/connect-review-notes/
---

# Review Notes (v1.0.5 build 3)
...
- Version-scoped legal URLs for this build:
  - Terms EN: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-5-build3/
  - Privacy EN: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-5-build3/
...
- 本版本规则说明入口：
  - 设置 -> 常见问题
- 本版本法务链接：
  - 服务条款（中文）：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-5-build3/
  - 隐私政策（中文）：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-5-build3/
