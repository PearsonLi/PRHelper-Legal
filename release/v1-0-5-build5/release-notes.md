...
- Previous version baseline: v1.0.5-build4
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-5-build5/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-5-build5/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-5-build5/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-5-build5/
...
- c0b0e89 fix(cloud): prevent empty snapshot overwrite and handle zero-absence trip import
- b6ca369 fix(bug): restore family trip records after reinstall
