---
title: Release Notes - v1.0.6 build 1
permalink: /release/v1-0-6-build1/release-notes/
---

# Release Notes - v1.0.6 (build 1)

- Generated at: 20260324_1833
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-6-build1/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-6-build1/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-6-build1/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-6-build1/
...
- e50e3f0 fix(migration): normalize countryCode in v3→v4 + remove dead code in v2→v3
- 1b61226 perf(member-switch): start cache prewarm earlier + non-blocking slow path
- ddcf53f fix(cloud): single push channel + merge-based trip restore (P0 fixes)
- 3026626 fix(cloud): restore trips on cloud sync pull + include trips in push payload
