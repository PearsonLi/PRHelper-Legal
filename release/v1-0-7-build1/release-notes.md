---
title: Release Notes - v1.0.7 build 1
permalink: /release/v1-0-7-build1/release-notes/
---

# Release Notes - v1.0.7 (build 1)

- Generated at: 20260325_2102
- Previous version baseline: v1.0.6-build2
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-7-build1/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-7-build1/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-7-build1/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-7-build1/
...
- 055c3f98 fix(bug): sync full trip table for cloud backup
- 7b077c87 fix(ui): simplify startup gate to logo + spinner
- e3407d1e fix(bug): add startup interaction gate to mask brief resume lock
