---
title: Release Notes - v1.0.7 build 3
permalink: /release/v1-0-7-build3/release-notes/
---

# Release Notes - v1.0.7 (build 3)

- Generated at: 20260329_2215
- Previous version baseline: v1.0.7-build2
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-7-build3/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-7-build3/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-7-build3/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-7-build3/
...
- Backup/restore internals were reverted to the stable v1.0.6 build 1 implementation path.
- Relaunch and reinstall data persistence reliability was improved for trip/PR/member/app settings.
- Startup purchase restore remains automatic and now runs without a user-facing success alert.
- Release legal URLs and release-scoped metadata were updated to v1.0.7 (build 3).
