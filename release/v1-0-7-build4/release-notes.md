---
title: Release Notes - v1.0.7 build 4
permalink: /release/v1-0-7-build4/release-notes/
---

# Release Notes - v1.0.7 (build 4)

- Generated at: 20260330_0120
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-7-build4/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-7-build4/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-7-build4/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-7-build4/
...
- 9770804 perf(persistence): defer serialization to debounce callback
- fb0a82c fix(persistence): add local file snapshot for reliable data persistence
- e0032c9 fix(persistence): remove KVS timestamps/license to prevent restore blocking
- 74788e7 fix(persistence): write data to disk immediately on every mutation
- 738fd1d release: v1.0.7 build 3
- 93cd145 fix(native): listen for CloudKit remote changes to restore data after reinstall
- e364df9 refactor(native): remove KVS (NSUbiquitousKeyValueStore) from sync layer
- 0a507af refactor(data-sync): remove KVS to fix reinstall data restore failure
- 83989d0 fix(data-sync): resolve P0 and P1 bugs in backup/restore/license logic
- 30fc1e0 fix(bug): prevent bootstrap empty snapshot overwrite
- 71a6ad3 fix(member-switch): avoid forced-primary flicker before license status loads
- a4a8904 fix(member-switch): isolate deferred trip data by member
- 0fca023 fix(member-switch): render transition overlay before heavy refresh
- ec63c06 fix(bug): isolate residency derivation to trip owner member
- 638a725 fix(member-switch): refresh full member data and enforce transition gate
