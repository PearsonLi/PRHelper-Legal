---
title: Release Notes - v1.0.7 build 6
permalink: /release/v1-0-7-build6/release-notes/
---

# Release Notes - v1.0.7 (build 6)

- Generated at: 20260330_1757
...
Terms of Use: https://pearsonli.github.io/PRHelper-Legal/terms/en/v1-0-7-build6/
Privacy Policy: https://pearsonli.github.io/PRHelper-Legal/privacy/en/v1-0-7-build6/
...
服务条款：https://pearsonli.github.io/PRHelper-Legal/terms/zh/v1-0-7-build6/
隐私政策：https://pearsonli.github.io/PRHelper-Legal/privacy/zh/v1-0-7-build6/
...
- 97708040 perf(persistence): defer serialization to debounce callback
- fb0a82c4 fix(persistence): add local file snapshot for reliable data persistence
- e0032c98 fix(persistence): remove KVS timestamps/license to prevent restore blocking
- 74788e7d fix(persistence): write data to disk immediately on every mutation
- 738fd1d0 release: v1.0.7 build 3
- 93cd145c fix(native): listen for CloudKit remote changes to restore data after reinstall
- e364df96 refactor(native): remove KVS (NSUbiquitousKeyValueStore) from sync layer
- 0a507afb refactor(data-sync): remove KVS to fix reinstall data restore failure
- 83989d09 fix(data-sync): resolve P0 and P1 bugs in backup/restore/license logic
- 30fc1e08 fix(bug): prevent bootstrap empty snapshot overwrite
- 71a6ad38 fix(member-switch): avoid forced-primary flicker before license status loads
- a4a89047 fix(member-switch): isolate deferred trip data by member
- 0fca023f fix(member-switch): render transition overlay before heavy refresh
- ec63c063 fix(bug): isolate residency derivation to trip owner member
- 638a725b fix(member-switch): refresh full member data and enforce transition gate
