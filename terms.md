...
hero_subtitle: Monthly subscription + one-time purchase terms, feature scope, data responsibility, and legal boundaries.
...
<ol start="1">
  ...
  <li><strong>Feature dependency</strong><br />Import/export, reminders, sharing, and in-app purchase features depend on system permissions, device state, network availability, and Apple service availability, and may be limited by the platform. Automatic location is under active development and disabled in the current release.</li>
...
<ol start="1">
  ...
  <li><strong>功能依赖</strong><br />导入导出、提醒、分享、应用内购买等能力依赖系统权限、设备状态、网络可用性与 Apple 服务状态，可能受系统限制。自动定位仍在开发中，当前发布版本默认关闭。</li>
