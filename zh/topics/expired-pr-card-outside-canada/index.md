---
title: 人在境外枫叶卡过期怎么办
permalink: /zh/topics/expired-pr-card-outside-canada/
layout: site
lang: zh-CN
hero_title_zh: 人在境外，枫叶卡过期了
hero_title_en: PR Card Expired Abroad
hero_subtitle_zh: 先分清永久居民身份、返加旅行证件和居住记录。
hero_subtitle_en: Separate status, return documents and travel-history evidence.
nav_key: topics
seo_title: 人在境外枫叶卡过期怎么办 | PRTD 与返加步骤
seo_description: "人在加拿大境外发现枫叶卡过期时，如何分清永久居民身份、PRTD、返加方式和旅行记录准备。"
seo_keywords: 境外枫叶卡过期,PRTD,永久居民旅行证件,没有有效枫叶卡返加
...
<h2>先确认三个结论</h2>
<ol>
  <li>枫叶卡过期本身不会自动终止永久居民身份。</li>
  <li>IRCC 说明，人在境外且没有有效枫叶卡时，乘商业交通工具返加通常需要永久居民旅行证件（PRTD）。</li>
  <li>不能把新枫叶卡寄到境外用于返加；回到加拿大后再申请新卡。</li>
</ol>

<h2>提交前先整理旅行历史</h2>
<p>按时间顺序列出每次离境与返回，包括同日往返。不确定日期先标记，不要用猜测填满。用护照、订票邮件、日历和可获得的边境记录交叉核对，再按照 IRCC 当前 PRTD 指引准备材料。</p>
...
<div class="conversion-strip"><div><h2>把分散行程变成可核对时间线</h2><p>整理已核实旅行日期和支持来源，让历史更容易复核；最终决定由 IRCC 作出。</p></div><div class="conversion-actions"><a class="btn btn-primary" data-funnel-stage="download" data-funnel-action="expired_card_start_timeline" data-funnel-experiment="expired_card_zh_v1" href="https://apps.apple.com/app/id6759813402" target="_blank" rel="noopener noreferrer">开始整理旅行时间线</a><small>独立规划工具 · 不是法律意见或 IRCC 服务</small></div></div>

<p><a data-funnel-stage="activation" data-funnel-action="expired_card_open_starter" data-funnel-experiment="expired_card_zh_v1" href="/PRHelper-Legal/zh/getting-started/">打开已核实行程流程 →</a></p>
